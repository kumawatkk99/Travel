...
<FORM ACTION="AddRoute1.jsp" onsubmit="return validate()">
   ...
   <TABLE BORDER="0" CELLSPACING="2"  CELLPADDING="2" >
	...
	<TD><Input type=text name='BusId' >	<INPUT TYPE="Button" Name="GBid" value="..." Onclick="fnEmpPopUp('ShowBuses.jsp',300,400);">
									  <!-- value=''readonly -->			
		</TR>
		<tr class="row_odd">
		...
		<tr class="row_even">
				 <td><label class="form-label">Journey Date<FONT COLOR="red">*</FONT></label><br></td>
							<td><input type="date" id="doj" name="JDate" class="form-control" required></td> 
						<!--	<TD>Journey Date<FONT COLOR="red">*</FONT></TD>
				<TD><Input type=text name='JDate' ><img onkeypress="fnCalendar(this)" id="imgDate" style="CURSOR: hand" onClick="fnCalendar(this)" height="16" src="Images/CalDis.gif" width="16" border="0" name="imgDate" onMouseOver="fnEnableCalLookup(this)" onMouseOut="fnDisableCalLookup(this)" ></TD>
	-->	</TR>
