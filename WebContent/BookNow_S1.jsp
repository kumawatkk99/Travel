...
<%
	...
	//System.out.println("gjhjg" + RouteSelected);
	...
	try
	{
		...
		{
			if(Route.charAt(i)=='_')	count11++;
			else{
				if(count11 ==0){
					RouteId=RouteId+Route.charAt(i);
				}
				if(count11==1){
					TravelsId=TravelsId+Route.charAt(i);
				}
				if(count11==2){
					BusId=BusId+Route.charAt(i);
				}
			}
		...
		System.out.println("aaaaaa" + TravelsId);
		System.out.println("r" + Route);
		System.out.println("aaaaaa" + RouteId);
		System.out.println("aaaaaa" + BusId);
		//TravelsId = Details[1];	
	...
	Choose number of seats <FONT COLOR="red">*</FONT>&nbsp;<INPUT TYPE="text" NAME="Seats" class="TextField">
	<BR>
	<!-- <FONT COLOR="#333399" size="-1" face='Times new roman'><I>select from the available seats from the layout below</I></FONT>x -->
	<H5>Bus Layout</H5>
