...
<%
	...
	String Query1="";
%>
<FORM Name='DelForm' METHOD=POST ACTION="DelTravel1.jsp" ">
	...
	try{
			...
			int rCount=0;
				while(rs.next()){
					...
					ConValues[i]=x;
					%><OPTION Value=<%=ConValues[i]%>><%=rs.getString(1)%></OPTION><%
					i++;
				}
		}catch(Exception e){%><%=e%><%}
%>
		...
		<TD align=center><input type="button" ID='Item' value="ShowDetails" onclick="fnEmpPopUp('ViewTravels.jsp',300,400);"></TD>
		</TR>
		</TABLE>
</FORM>
</BODY>
